...
DELTA = 20000  # Set this to match your subgroup generation threshold

def plot_subgroups_graph(file_path, data_path):
    """
    ...
    The plot title includes the condition, treatment, and the maximum utility diff (homogeneity measure).
    """
...
if __name__ == "__main__":
    results_path = '/Users/sgahtan/Desktop/shira/studies/brit_project/FairCap-D4AD/src/algorithms/metrics/results_by_subgroup/subgroups_results0.xlsx'
    data_path = '/Users/sgahtan/Desktop/shira/studies/brit_project/FairCap-D4AD/data/stackoverflow/so_countries_col_new.csv'
    plot_subgroups_graph(results_path, data_path)